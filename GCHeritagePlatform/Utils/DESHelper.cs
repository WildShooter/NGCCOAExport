...
namespace GCHeritagePlatform.Utils
{
    public class DESHelper
    {
        ...
        #region DES对称加密解密
        private const string DEFAULT_ENCRYPT_KEY = "gxsnerp2016";
        ...
        /// <param name="strEncrKey">key</param> 
        private static void DesEncrypt(string m_InFilePath, string m_OutFilePath, string strEncrKey)
        {
            byte[] byKey = null;
            byte[] IV = { 0x12, 0x34, 0x56, 0x78, 0x90, 0xAB, 0xCD, 0xEF };
        ...
        /// <param name="sDecrKey">key</param> 
        private static void DesDecrypt(string m_InFilePath, string m_OutFilePath, string sDecrKey)
        {
            byte[] byKey = null;
            byte[] IV = { 0x12, 0x34, 0x56, 0x78, 0x90, 0xAB, 0xCD, 0xEF };
